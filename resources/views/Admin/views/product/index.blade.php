                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control js-select2-custom" onchange="getRequest('{{url('/')}}/admin/product/get-categories?parent_id='+this.value,'sub-categories')">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="brand" class="form-control js-select2-custom" id="selectbrand"> 
                                        ...
                                        @foreach($brand as $value)
                                            <option value="{{$value['id']}}" data-name="{{$value['name']}}">{{translate($value['name'])}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
