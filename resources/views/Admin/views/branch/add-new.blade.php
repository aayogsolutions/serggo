                                                ...
                                                <div class="col-sm-6 col-md-4">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="password" name="password" class="form-control" placeholder="{{ translate('Ex: 8+ Character') }}" maxlength="255" value="{{ old('password') }}" required>
...
@push('script_2')
    <script src="https://maps.googleapis.com/maps/api/js?key={{ Helpers_get_business_settings('map_api_client_key') }}&libraries=places&v=3.45.8"></script>
