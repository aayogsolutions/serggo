                        ...
                        <td>
                            <label class="toggle-switch my-0">
                                <input type="checkbox" class="toggle-switch-input status-change-alert"
                                    ...
                                    data-route="{{ route('admin.vendor.status', [$vendor->id, $vendor->status == 1 ? 0 : 1]) }}"
                                    data-message="{{ $vendor->status? translate('you_want_to_change_the_status_for_this_customer'): translate('you_want_to_change_the_status_for_this_customer') }}"
                                    {{ $vendor->status == 0? 'checked' : '' }}>
