            ...
            <div class="d-flex flex-wrap justify-content-between">
                <h1 class="page-header-title text-break">
                    <span class="page-header-icon">
                        <img src="{{asset('assets/admin/img/product.png')}}" alt="">
                    </span>
                        ...
                        <div class="row align-items-md-center">
                            ...
                            <div class="col-lg-8 col-md-6 mx-auto">
                                <ul class="list-unstyled list-unstyled-py-2 mb-0 rating--review-right py-3">
                                    ...
                                    <!-- Review Ratings -->
                                    <li class="d-flex align-items-center font-size-sm">
                                        @php($four = Helpers_rating_count($product['id'],4))
                                    ...
                                    <li class="d-flex align-items-center font-size-sm">
                                        @php($two = Helpers_rating_count($product['id'],2))
                                    ...
                                    <li class="d-flex align-items-center font-size-sm">
                                        @php($one = Helpers_rating_count($product['id'],1))
                                    ...
                                    @if(isset($review->customer))
                                        <a class="d-flex align-items-center" href="{{route('admin.customer.view',[$review['user_id']])}}">
                                            <div class="avatar avatar-circle">
                                                <img class="avatar-img" width="75" height="75" src="{{$review->customer}}" alt="Image Description" onerror="this.src='{{asset('assets/admin/img/160x160/2.png')}}'">
                                            </div>
                                            <div class="ml-3">
                                                <span class="d-block h5 text-capitalize text-hover-primary mb-0">{{$review->customer['f_name']." ".$review->customer['l_name']}} 
