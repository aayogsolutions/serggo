                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.business-settings.store.delivery-setup-update')}}" method="post"
                            ...
                            @csrf
                            <div class="row">
                                @php($config= Helpers_get_business_settings('delivery_management'))
                                ...
                                <div class="col-md-6 col-sm-6 pt-5">
                                    <?php
                                    $free_delivery_status= Helpers_get_business_settings('free_delivery_over_amount_status');
                                ...
                                @php($free_delivery_over_amount=Helpers_get_business_settings('free_delivery_over_amount'))
