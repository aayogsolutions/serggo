...
class LoginController extends Controller
{
    ...
    {
        $logoName = Helpers_get_business_settings('logo');
        $logo = asset('assets/admin/img/160x160/img2.jpg');
        return view('branch.auth.login', compact('logo'));
    }
    ...
    public function submit(Request $request): RedirectResponse
    {
        ...
        // $recaptcha = Helpers_get_business_settings('recaptcha');
        // if (isset($recaptcha) && $recaptcha['status'] == 1) {
        //     $request->validate([
        //         'g-recaptcha-response' => [
        //             function ($attribute, $value, $fail) {
        //                 $secret_key = Helpers_get_business_settings('recaptcha')['secret_key'];
        //                 $response = $value;
