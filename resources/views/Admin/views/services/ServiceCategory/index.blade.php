...
<div class="content container-fluid">
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('Service_category_setup')}}
            </span>
        </h1>
    </div>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="card--header">
                        <h5 class="card-title">{{translate('Service Category Table')}} <span class="badge badge-soft-secondary">{{ $categories->total() }}</span> </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="max-85">
                                        <select name="priority" class="custom-select"
                                            onchange="location.href='{{ route('admin.service.category.priority', ['id' => $category['id'], 'priority' => '']) }}' + this.value">
                                            @for($i = 1; $i <= 10; $i++)
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        <a class="action-btn" href="{{route('admin.service.category.edit',[$category['id']])}}">
                                            <i class="tio-edit"></i>
                                        </a>
