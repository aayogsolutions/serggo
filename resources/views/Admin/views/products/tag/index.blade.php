        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="card--header">
                    ...
                    <button class="btn btn--primary ml-lg-4" data-toggle="modal" data-target="#tag-modal"><i class="tio-add"></i> {{translate('Add tag')}}</button>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group lang_form" id="-form">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="{{translate('New tag')}}" maxlength="255">
                                </div>
                            </div>
                        </div>
