...
class OrderController extends Controller
{
    ...
    public function list(Request $request, $status): View|Factory|Application
    {
        ...
        $orders = $orders->notPos()->orderBy('id','desc')->paginate(Helpers_getPagination())->appends($queryParam);
        ...
        return view('branch.order.list', compact('orders', 'status','search', 'countData', 'startDate', 'endDate'));
    }
    ...
    public function offlineQuickViewDetails(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'view' => view('branch.order.offline-payment.details-quick-view', compact('order'))->render(),
        ]);
    }
}
