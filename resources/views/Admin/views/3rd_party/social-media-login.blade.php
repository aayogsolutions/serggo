                ...
                <div class="card __social-media-login __shadow">
                    <div class="card-body">
                        <div class="__social-media-login-top">
                            ...
                            <div class="custom--switch switch--right change-social-login-status" data-route="{{route('admin.business-settings.web-app.third-party.google-social-login',[$googleLoginService == 0 ? 1 : 0])}}">
                                <input type="checkbox" id="google_social_login" name="google" switch="primary" class="toggle-switch-input" {{ $googleLoginService == 0 ? 'checked' : '' }}>
                ...
                <div class="card __social-media-login __shadow">
                    <div class="card-body">
                        <div class="__social-media-login-top">
                            ...
                            <div class="custom--switch switch--right change-social-login-status" data-route="{{route('admin.business-settings.web-app.third-party.facebook-social-login',[$facebookLoginService == 0 ? 1 : 0])}}">
                                <input type="checkbox" id="facebook" name="facebook_social_login" switch="primary" class="toggle-switch-input" {{ $facebookLoginService == 0 ? 'checked' : '' }}>
                                ...
                                <div class="__social-media-login-top flex-grow-1">
                                    ...
                                    <div class="custom--switch switch--right">
                                        <input type="checkbox" id="apple" name="status" switch="primary" class="toggle-switch-input"
                                            {{$appleLoginService['status'] == 0 ? 'checked' : ''}}>
