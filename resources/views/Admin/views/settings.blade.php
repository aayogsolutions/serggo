...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
                  ...
                  <span class="navbar-toggle-toggled">
                    ...
                    <div id="navbarVerticalNavMenu" class="collapse navbar-collapse">
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#passwordDiv" id="passwordSection">
            ...
            <div class="col-lg-9">
                <form action="{{route('admin.UpdateSettings')}}" method="post" enctype="multipart/form-data" id="admin-settings-form">
                @csrf
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="js-masked-input form-control" name="number" id="phoneLabel"
                                           placeholder="+x(xxx)xxx-xx-xx" aria-label="+(xxx)xx-xxx-xxxxx"
                                           value="{{auth('admins')->user()->number}}"
