...
class WalletBonusController extends Controller
{
    ...
    public function index(Request $request): Factory|View|Application
    {
        ...
        $bonuses = $bonuses->latest()->paginate(Helpers_getPagination())->appends($queryParam);
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        flash()->success(translate('bonus_added_successfully'));
        return back();
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        flash()->success(translate('bonus_updated_successfully'));
    ...
    public function status(Request $request): RedirectResponse
    {
        ...
        flash()->success(translate('Bonus status updated!'));
        return back();
    }
    ...
    public function delete(Request $request): RedirectResponse
    {
        ...
        flash()->success(translate('Bonus removed!'));
        return back();
    }
}
