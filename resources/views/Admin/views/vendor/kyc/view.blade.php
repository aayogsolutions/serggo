        ...
        <div class="row mb-2 g-2">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="resturant-card bg--2">
                    ...
                    @if($vendor->delivery_choice == 0)
                        <div class="for-card-text font-weight-bold  text-uppercase mb-1">
                            {{translate('delivery_type')}} : <span>{{ $vendor->delivery_type }}</span>
                        </div>
                    @else
                        <div class="for-card-text font-weight-bold  text-uppercase mb-1">
                            {{translate('delivery_type')}} : {{translate('Not Acceptable')}}
                        </div>
                    @endif
                    
                    <div class="for-card-text font-weight-bold  text-uppercase mb-1">
                        {{translate('working_days')}} : <span>@foreach(json_decode($vendor->working_days) as $key => $working) {{ $key == 0 ? $working : ', '. $working }} @endforeach</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <form action="{{ route('admin.vendor.kyc.store', $vendor->id) }}" method="post">
                            @csrf
