...
class DashboardController extends Controller
{
     ...
     public function dashboard(): View|Factory|Application
    {
        ...
        $data['recent_orders'] = $this->order->where('branch_id', auth('branch')->id())->latest()->take(5)->get(['id', 'created_at', 'order_status']);
    ...
    return view('branch.dashboard', compact('data', 'earning', 'orderStatisticsChart'));
    ...
    public function orderStats(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'view' => view('branch.partials._dashboard-order-stats', compact('data'))->render()
        ], 200);
    }
