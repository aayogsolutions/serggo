...
<div class="content container-fluid">
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('Auth banners setup')}}
            </span>
        </h1>
    </div>
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{route('admin.banners.auth.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    ...
                                    <select name="screen" class="form-control show-item">
                                        <option value="login">{{translate('log_in')}}</option>
                                        <option value="signup">{{translate('sign_up')}}</option>
                                        <option value="verify">{{translate('OTP_verify')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="border-0">{{translate('Screen type')}}</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="toggle-switch my-0">
                                <input type="checkbox"
                                    ...
                                    data-route="{{ route('admin.banners.auth.status', [$banner->id, $banner->status == 1 ? 0 : 1,$banner->ui_type,$banner->section_type]) }}"
                        ...
                        <td>
                            <div class="btn--container justify-content-center">
                                <a class="action-btn"
                                    href="{{route('admin.banners.auth.edit',[$banner['id']])}}">
                            ...
                            <form action="{{route('admin.banners.auth.delete',[$banner['id']])}}"
