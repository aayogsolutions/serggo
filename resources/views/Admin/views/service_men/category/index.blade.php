...
<div class="content container-fluid">
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('Partner_category_setup')}}
            </span>
        </h1>
    </div>
        ...
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                <div class="card-body pt-sm-0 pb-sm-4">
                    <form action="{{route('admin.service_men.category.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="toggle-switch">
                                        <input type="checkbox"
                                            ...
                                            data-route="{{ route('admin.service_men.category.status', [$category->id, $category->status == 1 ? 0 : 1]) }}"
                                ...
                                <td>
                                    <div class="max-85">
                                        <select name="priority" class="custom-select" onchange="location.href='{{ route('admin.service_men.category.priority', ['id' => $category['id'], 'priority' => '']) }}' + this.value">
                                            @for($i = 1; $i <= 10; $i++)
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        <a class="action-btn" href="{{route('admin.service_men.category.edit',[$category['id']])}}">
                                            <i class="tio-edit"></i>
                                        </a>
                                    ...
                                    <!-- <form action="{{route('admin.service_men.category.delete',[$category['id']])}}"
