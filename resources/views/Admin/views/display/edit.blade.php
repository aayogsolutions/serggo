...
<div class="content container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.display.slider.update',[$banner['id']])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    <label class="input-label" for="exampleFormControlSelect1">{{translate('item')}} {{translate('type')}}
                                        <span class="input-label-secondary">*</span>
                                    </label>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-column justify-content-center h-100">
                            ...
                            <label class="upload--vertical">
                                ...
                                <img class="" id="viewer" src="{{asset('Images/banners/').'/'.$banner->attechment}}" alt="{{ translate('banner image') }}" />
