                        ...
                        <div class="col-md-12 my-2">
                            <ul class="list-group overflow-auto initial--23">
                                    ...
                                    <li class="list-group-item">
                                        <span class="dm_list" role='button' data-id="">
                                        ...
                                        <a class="btn btn-primary btn-xs float-right assign-deliveryman" data-deliveryman-id="">{{ translate('assign') }}</a>
                                    </li>
        ...
        $(document).on('change', '#from_date', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.post({
                        url: "{{route('admin.orders.update.service.men')}}",
