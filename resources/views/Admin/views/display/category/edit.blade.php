...
<div class="content container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.display.category.update',[$banner['id']])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-column justify-content-center h-100">
                            ...
                            <label class="upload--vertical">
                                ...
                                <img class="" id="viewer" src="{{asset($banner->attechment)}}" alt="{{ translate('banner image') }}" onerror="this.src='{{asset('assets/admin/img/upload-vertical.png')}}'"/>
