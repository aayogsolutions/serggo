...
@section('title', translate('Add new service sub category'))
...
<div class="content container-fluid">
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('Service_sub_category_setup')}}
            </span>
        </h1>
    </div>
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="card--header">
                    <h5 class="card-title">{{translate('Service Sub Category Table')}} <span class="badge badge-soft-secondary">{{ $categories->total() }}</span> </h5>
