...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.business-settings.store.service.timeSlot.update',[$timeSlots['id']])}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label">{{translate('Time')}}</label>
                                <input type="time" value="{{$timeSlots['time']}}" name="time" class="form-control">
                            </div>
                        </div>
                    </div>
